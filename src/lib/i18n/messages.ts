...
const en: Dict = {
  ...
  "lang.label": "Language",
  // Access protection
  "auth.title": "Enter access password",
  "auth.description": "This studio is protected to prevent unauthorized API usage.",
  "auth.passwordLabel": "Access password",
  "auth.passwordPlaceholder": "Enter the configured password",
  "auth.submit": "Continue",
  "auth.submitting": "Checking…",
  "auth.logout": "Sign out",
  "auth.unconfiguredTitle": "Access protection is not configured",
  "auth.unconfiguredDescription": "Set APP_ACCESS_PASSWORD and SESSION_SECRET on the server before using this deployment.",
  ...
  "api.authNotConfigured": "Server access protection is not configured.",
  "api.unauthorized": "Enter the access password to continue.",
  "api.passwordRequired": "Enter the access password.",
  "api.invalidPassword": "The access password is incorrect.",
...
const zh: Dict = {
  ...
  "lang.label": "语言",
  "auth.title": "请输入访问密码",
  "auth.description": "工作台已启用访问保护，以避免 API 被未授权使用。",
  "auth.passwordLabel": "访问密码",
  "auth.passwordPlaceholder": "输入服务器配置的访问密码",
  "auth.submit": "进入工作台",
  "auth.submitting": "正在验证…",
  "auth.logout": "退出",
  "auth.unconfiguredTitle": "访问保护尚未配置",
  "auth.unconfiguredDescription": "请先在服务器配置 APP_ACCESS_PASSWORD 和 SESSION_SECRET。",
  ...
  "api.authNotConfigured": "服务器访问保护尚未配置。",
  "api.unauthorized": "请输入访问密码后继续。",
  "api.passwordRequired": "请输入访问密码。",
  "api.invalidPassword": "访问密码不正确。",
